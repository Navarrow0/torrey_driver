          ...
          SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Image.asset('images/ic_app_logo.png', width: 100,),
                  SizedBox(height: 16),
                  Text(language.welcomeBack, style: boldTextStyle(size: 28)),
                  SizedBox(height: 8),
                  Text(language.signInYourAccount, style: primaryTextStyle(size: 18)),
                  SizedBox(height: 32),
                  AppTextField(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Checkbox(
                          ...
                          activeColor:  Color.fromRGBO(28, 31, 42, 1),
                          value: mIsCheck,
