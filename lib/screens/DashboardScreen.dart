                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 12),
                                                    Text('Detalle de recolección', style: boldTextStyle(size: 14)),
                                                    ClipRRect(
                                                      borderRadius: BorderRadius.circular(defaultRadius),
                                                      child: commonCachedNetworkImage(servicesListData!.riderTarimaImage.validate(), height: 80, width: 80, fit: BoxFit.cover),
                                                    ),
                                                    SizedBox(height: 12),
                                                    Row(
                                                      children: [
