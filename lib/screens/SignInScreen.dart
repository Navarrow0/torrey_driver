                ...
                children: [
                  ...
                  Align(
                    ...
                    child: inkWellWidget(
                      ...
                      child: Text(language.forgotPassword, style: primaryTextStyle(size: 13)),
                    ),
                  ),
                  SizedBox(height: 12),
                  Row(
                    children: [
                      ...
                      inkWellWidget(
                        ...
                        child: Text(language.rememberMe, style: primaryTextStyle(size: 13)),
                      ),
                    ],
                  ),
                  SizedBox(height: 16),
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(text: ' & ', style: primaryTextStyle(size: 13)),
                              TextSpan(
